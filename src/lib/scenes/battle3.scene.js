...
import { bgMapBattle3, loadBgTileMap, loadFgTileMap, fgMapBattle3 } from "./sceneTiles";
...
import { battle4 } from "./battle4.scene";
    ...
    const redefines = {
        ...
        doors: [
            ...
            new Door(
                ...
                -507, 155,
                battle4, { x: 395, y: 200 }, ["stick", "yellow", "green", "purple"], true
            ),
...
export const battle3 = new Scene({
